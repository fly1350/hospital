...
public class MyShiroRealm extends AuthorizingRealm {
    ...
    @Resource
    private StaffService userInfoService;
...
//        System.out.println(token.getCredentials());
        ...
        StaffDict userInfo = userInfoService.findByUserName(username);
...
//        StaffDict userInfo = (StaffDict) principals.getPrimaryPrincipal();
